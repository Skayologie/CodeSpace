export default class Form {
    ...
    constructor(formSelector) {
        ...
        this.titleError = this.form.querySelector("#titleError");
        this.titleErrorMessage = this.form.querySelector("#titleErrorMessage");
        this.titleCounter = this.form.querySelector("#titleCounter");
        this.description = this.form.querySelector("#description");
        this.descriptionCheck = this.form.querySelector("#descriptionCheck");
        this.descriptionCounter = this.form.querySelector("#descriptionCounter");
        this.privateToggle = this.form.querySelector("#privateToggle");
        this.profileDisplayOption = this.form.querySelector("#profileDisplayOption");
        this.profileDisplayCheck = this.form.querySelector("#profileDisplayCheck");
        this.closeButton = this.form.querySelector("#closeButton");
    ...
    init() {
        ...
        this.btnSubmit.addEventListener('click', (event) => console.log("hello"));
    }
