...
<div id="LoadingOne" class="hidden fixed w-full h-full z-[120] items-center block p-6 bg-white border border-gray-100 rounded-lg shadow-md dark:bg-gray-800/50 dark:border-gray-800 ">
