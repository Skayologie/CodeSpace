<x-UserHompage>
    <div id="inviteModoForm" class="hidden fixed inset-0 bg-black/50 bg-opacity-50 flex items-center justify-center z-[120]">
        <!-- Modal Container -->
    ...
    <div class="flex items-center px-4 py-2 bg-white border-b border-gray-300">
        ...
        <div class="flex gap-2">
            <a href="{{route('Post.index')}}?Type=" class="flex items-center px-4 py-2 bg-white border border-gray-300 rounded-full hover:bg-gray-100">
