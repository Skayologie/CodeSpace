    ...
    <tbody class="divide-y divide-gray-200">
        @foreach($data as $stats)
            <tr class="hover:bg-gray-50 transition">
                ...
                <td class="px-6 py-4 text-gray-600 truncate max-w-xs">{{$stats->content}}</td>
                <td class="px-6 py-4">
                    <span class="inline-block bg-blue-100 text-blue-800 text-xs px-2 py-1 rounded-full">{{$stats->categoryName}}</span>
                </td>
